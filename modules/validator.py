...
def validate_search() -> None | ValueError | TypeError:
    ...
    check_boolean(enforce_search_term_title_match, "enforce_search_term_title_match")
    check_list(search_term_optional_tokens, "search_term_optional_tokens")
    check_int(min_title_token_overlap, "min_title_token_overlap", 0)
    check_boolean(enforce_target_location_match, "enforce_target_location_match")
    check_boolean(strict_filter_apply_required, "strict_filter_apply_required")
...
def validate_settings() -> None | ValueError | TypeError:
    ...
    check_boolean(enable_external_apply_ai, "enable_external_apply_ai")
    check_boolean(external_apply_pause_before_submit, "external_apply_pause_before_submit")
    check_list(external_apply_portals, "external_apply_portals", ["workday", "greenhouse", "lever"])
    check_boolean(external_apply_generic_fallback, "external_apply_generic_fallback")
    check_string(external_auth_mode, "external_auth_mode", ["manual_first_login", "auto_login", "skip_auth_required"])
